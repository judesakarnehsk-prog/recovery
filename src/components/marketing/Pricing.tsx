...
const faqs = [
  ...
  },
  {
    ...
    a: "Each email is generated by Claude (Anthropic's AI) using your customer's name, the amount owed, your business name, and your chosen tone. The AI is constrained to a specific template — it never invents information or hallucinates. If our AI provider is unavailable, emails fall back to a clean, branded template automatically.",
  },
  {
        ...
        <div className="flex items-center justify-center gap-3 mb-10">
          ...
          <span className={cn('text-sm font-medium', annual ? 'text-ink' : 'text-muted')}>
            ...
            <motion.span
              ...
              className={cn(
                'inline-block text-xs font-semibold ml-1 px-1.5 py-0.5 rounded-full transition-colors',
                annual
